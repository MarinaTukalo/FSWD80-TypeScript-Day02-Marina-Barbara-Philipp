class Vehicle {
    ...
    constructor(performance, model, km, seats, fuel, year, img) {
...
class VehicleMotor extends Vehicle {
    constructor(performance, model, km, seats, fuel, year, img, motor) {
...
class VehicleTruck extends Vehicle {
    constructor(performance, model, km, seats, fuel, year, img, truck) {
        super(performance, model, km, seats, fuel, year, img);
        this.truck = truck;
    }
    ;
