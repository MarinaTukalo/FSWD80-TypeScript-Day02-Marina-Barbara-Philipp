...
class Veh {
   ...
   kilometer:number;
   img:string;
constructor(description:string, model:string, ps:number, year:number, kilometer:number, img:string) {
...
class Car extends Veh {
   ...
   constructor(description:string, model:string, ps:number, year:number, kilometer:number, img:string, seats:number) {
...
class Truck extends Veh {
   ...
   constructor(description:string, model:string, ps:number, year:number, kilometer:number, img:string, height:string) {
       super(description, model, ps, year, kilometer, img)
       this.height = height;
   }
   ...
   //                      <li class="list-group-item font-weight-bold">Kilometer: <span class="font-weight-normal">${this.kilometer}</span></li>
   //                      <li class="list-group-item font-weight-bold">Year: <span class="font-weight-normal">${this.year}</span></li>
   //                       <li class="list-group-item font-weight-bold">Height: <span class="font-weight-normal">${this.height}</span></li>
   //                  </ul>
   //                  <div class="card-body">
   //                      <button class="btn buttonShowMore">Price</button>
   //                      <span id="printPrice" class="ml-4">€ 120</span>
